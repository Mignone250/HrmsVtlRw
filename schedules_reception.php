        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-list"></i>Create Schedule/My schedule</li>
              <li><i class="fa fa-list"></i>My Schedule</i></li>
            </ol>
          </div>
        </div>
...
<tr><td style="color:gray; font-size:16px;font-family: 'Lato', sans-serif;">Department&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $DEPARTMENT ?></td></tr>
<tr><td style="color:gray;font-size:16px;font-family: 'Lato', sans-serif;">From&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $dates ?></td></tr>
...
<div class="col-sm-12">
		<form action="" method="post" enctype="multipart/form-data" >
          ...
          <th style="background-color:#072f5f; color:white;font-size:14px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Task</th>
          <th style="background-color:#072f5f;font-size:14px;color:white;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Deadline</th>
		  <th style="background-color:#072f5f; font-size:14px;color:white;font-family: 'Lato', sans-serif; border:none;font-weight: lighter;">Status&nbsp;(You can change the status accordingly)<br></th>
		  <th style="background-color:#072f5f;font-size:14px;color:white;font-family: 'Lato', sans-serif; border:none;font-weight: lighter;">Challenge/Comment<br></th>
		  </tr></thead><tbody>
		  
            <tr>          
            <td style="font-size:14px;font-family: 'Lato', sans-serif;"> <?php echo @$task1 ?></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif; "> <center> <span style='background-color:blue; color:white; text-align:center; border-radius:25%;'><?php echo @$deadline_task1 ?></span></center></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif;">
			 <select  name="Status_task12" style='  color:gray; width:50%; border:none;'>
			...
			<td style="font-size:14px;font-family: 'Lato', sans-serif; "><center> <span style='background-color:blue; color:white; text-align:center; border-radius:25%;'> <?php echo @$deadline_task2 ?></span></center></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif;">
			 <select  name="Status_task22" style=' color:gray; width:50%; border:none;'>
			...
			<td style="font-size:14px;font-family: 'Lato', sans-serif; "><center> <span style="background-color:blue; color:white; text-align:center; border-radius:25%;"> <?php echo @$deadline_task3 ?></span></center></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif;">
			 <select  name="Status_task32" style='color:gray; width:50%; border:none;'>
			...
			<td style="font-size:14px;font-family: 'Lato', sans-serif;"> <center> <span style='background-color:blue; color:white; text-align:center; border-radius:25%;'><?php echo @$deadline_task4 ?></span></center></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif;">
			 <select  name="Status_task42" style=' color:gray; width:50%; border:none;'>
			...
			<td style="font-size:14px;font-family: 'Lato', sans-serif;"><center> <span style='background-color:blue; width:100px; color:white; text-align:center; border-radius:25%;'><?php echo @$deadline_task5 ?></span></center></td>
			<td style="font-size:14px;font-family: 'Lato', sans-serif;">
			 <select  name="Status_task52" style=' color:gray; width:50%; border:none;'>
