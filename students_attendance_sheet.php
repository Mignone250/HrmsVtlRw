...
$sql_t = "SELECT * FROM bachelor_roll_call_attendance WHERE tbl_id = '$ID' and  todate='$date'";
...
$sql = "INSERT INTO bachelor_roll_call_attendance (tbl_id,todate,arrived_at,arrival_status,left_at,leaving_status,day_status)
