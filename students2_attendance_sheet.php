...
$sql_t = "SELECT * FROM e_learning_rollcall_attendance WHERE e_learning_id = '$ID' and  todate='$date'";
...
$sql = "INSERT INTO e_learning_rollcall_attendance (e_learning_id,todate,arrived_at,arrival_status,left_at,leaving_status,day_status)
...
$sql = "SELECT * FROM e_learning_students_registration WHERE e_learning_id = $ID"; 
   ...
   <div class="tbl-header2">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <tr><th style=" font-size:14px;font-family: 'Lato', sans-serif; font-weight:lighter;">Student Names:&nbsp;&nbsp; &nbsp;&nbsp;<span style="color:blue;font-family: 'Lato', sans-serif;font-weight:lighter;"><?php  echo $FIRST." ".$LAST  ?></span></th>
...
$sql="UPDATE e_learning_rollcall_attendance SET todate='$date',arrived_at='$newarrivedat',arrival_status='$arrival_status',left_at='$newleftat',leaving_status='$leaving_status',day_status='$day_status' WHERE e_learning_id = '$ID' and todate = '$date' "; 
if(mysqli_query($conn, $sql)){
    echo "<div class='col-lg-9' id='helpdiv'>
								 <div style='background-color:#C2E1C0;color:green;text-align:center;font-size:17px;padding:10px;border-radius:5px;box-shadow: 0 4px 4px -4px black;'>
