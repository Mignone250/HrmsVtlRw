				  ...
				  <div id="id02" class="modal">
												  ...
												  <div style="width:50%;" class="modal-content animate">
													<div class="imgcontainer">
														<center><h3 class="heading2" style="color:grey; font-family:lato;"><b>EDIT PROFILE PICTURE </b><span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span></h3>
														<br>
