...
?>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <a href="schedules.php" style="color:white"><div class="info-box brown-bg">
 ...
 ?>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
		    ...
		    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <a href="attendancehistory4.php"><div class="info-box green-bg">
              <i class="fa fa-list" style="font-size:48px"></i>
              <div class="count">
			  <?php 
				$abc="SELECT count(*) as total FROM  roll_call_attendance where day_status = 'Absent' and USER_ID ='".$_SESSION['user']."'";
				$result=mysqli_query($conn,$abc);
				if($result)
				{
				while($row=mysqli_fetch_assoc($result))
...
if ($stmt = $mysqli->prepare('select * from post  ORDER BY POST_ID LIMIT ?,?')) {
	...
	<div class="col-lg-12 col-md-12" id="announcements">
			...
			<ul class="pagination">
				<?php if ($page > 1): ?>
				<li class="prev"><a href="User_dashboard.php?page=<?php echo $page-1 ?>">Prev</a></li>
				<?php endif; ?>

				<?php if ($page > 3): ?>
				<li class="start"><a href="User_dashboard.php?page=1">1</a></li>
				<li class="dots">...</li>
				<?php endif; ?>

				<?php if ($page-2 > 0): ?><li class="page"><a href="User_dashboard.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
				<?php if ($page-1 > 0): ?><li class="page"><a href="User_dashboard.php?page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

				<li class="currentpage"><a href="User_dashboard.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>

				<?php if ($page+1 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="User_dashboard.php?page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
				<?php if ($page+2 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="User_dashboard.php?page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

				<?php if ($page < ceil($total_pages / $num_results_on_page)-2): ?>
				<li class="dots">...</li>
				<li class="end"><a href="User_dashboard.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
				<?php endif; ?>

				<?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
				<li class="next"><a href="User_dashboard.php?page=<?php echo $page+1 ?>">Next</a></li>
				<?php endif; ?>
			</ul>
			</CENTER>
			<?php endif; ?>
