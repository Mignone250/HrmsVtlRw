        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-list">Schedule</i></li>
            </ol>
          </div>
        </div>
...
<td style='color:gray;'><b>DATES&nbsp;:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $dates ?></td><td style='color:gray;'><b>POSITION&nbsp;:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $POSITION ?></td>
</tr>
</table>
...
$sql ="SELECT * FROM schedules2 WHERE USER_ID = $ID"; 
					$result = $conn->query($sql);
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
								$task1=$row["task1"];
