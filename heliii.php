  ...
  <!-- container section start -->
    ...
    <section id="main-content" >
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fas fa-list"></i> STUDENTS</h3>
            <ol class="breadcrumb">
...
echo "<div class='col-lg-9' id='helpdiv'>
								 ...
								 <strong>Success!</strong> You successfully added $fname &nbsp; as the new applicant for &nbsp; $position.</div></div><br><br><br>";
								 echo "<script type='text/javascript'>
								window.setTimeout('closeHelpDiv();', 3000);
...
<div class="col-sm-12">
		<form action="" method="post" enctype="multipart/form-data">
          ...
          <th style="background-color:Lavender; font-size:12px; ">FIRST NAME</th>
          <th style="background-color:Lavender; font-size:12px; ">LAST NAME</th>
          <th style="background-color:Lavender; font-size:12px;">DATE OF BIRTH</th>
		  <th style="background-color:Lavender; font-size:12px; ">EMAIL</th>
		  <th style="background-color:Lavender; font-size:12px; ">CV</th>
		  <th style="background-color:Lavender; font-size:12px; ">COVER LETTER</th>
		  <th style="background-color:Lavender; font-size:12px; ">POSITION</th>
		  <th style="background-color:Lavender; font-size:12px; ">APPLICATION DATES</th>
		  <th style="background-color:Lavender; font-size:12px; ">RESPOND</th>
		  </tr></thead><tbody>
		  <?php 
$sql ="SELECT * FROM  applicants"; 
			...
			<td style='font-size:19px;'> <?php echo $lname;  ?></td>
			<td style='font-size:19px;'> <?php echo $dob;?></td>
			<td style='font-size:19px;'> <?php echo $email ?></td>
			<td style='font-size:19px;'> <?php echo $cv ?></td>
			<td style='font-size:19px;'> <?php echo $coverletter ?></td>
			<td style='font-size:19px;'> <?php echo $position ?></td>
			<td style='font-size:19px;'> <?php echo $application_date ?></td>
