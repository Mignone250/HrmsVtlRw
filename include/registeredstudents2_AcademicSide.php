			...
			<table border="1"class="table bootstrap-datatable countries">
				...
				<tr>
					<td><?php echo $user_id;  ?></td>
						...
						<td><a href="students2_attendancehistory_AcademicSide.php<?php echo '?tbl_id='.$user_id; ?>"><button class="btn" style="background-color:lavender;color:black;font-size:12px;margin-left:20px;">Attendance History</button></a></td>
