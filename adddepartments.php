...
<?php
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-user-md"></i>Departments</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="Admin_dashboard.php">Home</a></li>
              <li><i class="fa fa-user"></i>Departments</li>
              <li><i class="fa fa-user-md"></i>Add Department</li>
            </ol>
          </div>
        </div>	
...
<?php
    ...
    if(isset($_POST['adddepartment']))
        {
$department = mysqli_real_escape_string($conn, $_REQUEST['departt_name']);

	$sql_t = "SELECT * FROM departments WHERE department_name='$department'";
...
echo "<div class='col-lg-9' id='helpdiv'>
								 ...
								 <strong>Success!</strong> department was added successfully.</div></div><br><br><br>";
          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Add New Department</div>
                  ...
                  <div class="form quick-post">
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="tags" name="departt_name">Department Name</label>
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="tags" name="departt_name" required>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-offset-2 col-lg-9">
                          <button type="submit" class="btn btn-primary" name="adddepartment">Add</button>
			  ...
			  <table class="table bootstrap-datatable countries" border="1">
                  <thead>
                    <tr>
                      ...
                      <th style="background-color: #152E48;color: white;">Departments</th>
                  ...
                  <tbody>
                    ...
                    <td><form action="deletedepartments.php?del=<?php echo $id ?>" method="post" ><button class="btn" name="delete" style="background-color:lavender;color:red;"><i class="fa fa-trash-o" style="font-size:20px;"></i></button></form></td>
