...
<div class="col-sm-12">
          ...
          <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Task</th>
          <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">When</th>
		  <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Notes<br></th>
		  <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Rerevant Reaources<br></th>
		  <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Status&nbsp;(Update Status When Your Done)<br></th>
		  <th style="background-color:#072f5f; color:white;font-size:12px;font-family: 'Lato', sans-serif; border:none;font-weight: lighter; ">Action<br></th>
		  </tr></thead><tbody>
		  <?php 
$sql ="SELECT * FROM onboarding WHERE USER_ID = '".$_SESSION['user']."'"; 
            ...
            <td style='font-size:20px;'><input type='hidden' name='task' style='border:none; font-weight:bold; background-color:#FF6347; color:white;' value='<?php echo $task ?>'> <?php echo @$task ?></td>
			
			<td style=' font-size:20px; color:white; font-weight:bold; background-color:#FAEBD7;'><p style='background-color:blue; border-radius:50px;text-align:center; width:80%;'> <?php echo @$when ?></p></td>
