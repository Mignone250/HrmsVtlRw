...
?>
      ...
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <a href="academics_leaveinfor.php"><div class="info-box blue-bg">
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <a href="academics_schedule.php" style="color:white"><div class="info-box brown-bg">
 ...
 ?>
          ...
          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
		    ...
		    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <a href="academics_attendancehistory4.php"><div class="info-box green-bg">
