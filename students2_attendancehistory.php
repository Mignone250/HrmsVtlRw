        ...
        <!-- page start-->
          ...
          <div class="col-lg-12">
            <section class="panel">
			  ...
			  <div id='absences' style="background-color:red; width:10%; height:9%; position:absolute; left:75%; top:2%; 
			  font-family: 'Lato', sans-serif; font-size:18px; color:white; text-align:center;"><strong>Absences<strong><br>
			  <?php
			  $abc="SELECT count(day_status) as total FROM e_learning_rollcall_attendance where day_status = 'Absent' AND e_learning_id ='$ID'";
...
$total_pages = $mysqli->query("SELECT * FROM e_learning_rollcall_attendance WHERE e_learning_id  = '$ID' ")->num_rows;
...
if ($stmt = $mysqli->prepare("SELECT * FROM e_learning_rollcall_attendance WHERE e_learning_id  = '$ID' ORDER BY attendaa_id LIMIT ?,?")) {
...
<td>
 ...
 <?php endwhile; ?>
			...
			<ul class="pagination">
				<?php if ($page > 1): ?>
				<li class="prev"><a href="students2_attendancehistory.php?page=<?php echo $page-1 ?>">Prev</a></li>
				<?php endif; ?>

				<?php if ($page > 3): ?>
				<li class="start"><a href="students2_attendancehistory.php?page=1">1</a></li>
				<li class="dots">...</li>
				<?php endif; ?>

				<?php if ($page-2 > 0): ?><li class="page"><a href="students2_attendancehistory.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
				<?php if ($page-1 > 0): ?><li class="page"><a href="students2_attendancehistory.php?page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

				<li class="currentpage"><a href="students2_attendancehistory.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>

				<?php if ($page+1 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="students2_attendancehistory.php?page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
				<?php if ($page+2 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="students2_attendancehistory.php?page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

				<?php if ($page < ceil($total_pages / $num_results_on_page)-2): ?>
				<li class="dots">...</li>
				<li class="end"><a href="students2_attendancehistory.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
				<?php endif; ?>

				<?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
				<li class="next"><a href="students2_attendancehistory.php?page=<?php echo $page+1 ?>">Next</a></li>
				<?php endif; ?>
			</ul>
			</CENTER>
			<?php endif; ?>
