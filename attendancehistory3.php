...
<!-- sidebar menu start-->
        ...
        <!-- page start-->
          ...
          <div class="col-lg-12">
            <section class="panel">
			  ...
			  <div id='absences' style="background-color:red; width:10%; height:6%; position:absolute; left:75%; top:5%; 
			  font-family:Gill Sans MT; font-size:18px; color:white; text-align:center;"><strong>Absences<strong><br>
			  <?php
  ...
  <td style='background-color:#518acb;width:9%;'>
<div style="background-color:#518acb;height:100%; width:11%; position:absolute; top:0px;left:89%;">
<button type="submit" class="fa fa-search" name="search" style = "color: white !important;  background-color:blue; border:none;
...
$sql = "SELECT * FROM user_registration WHERE USER_ID = $ID"; 
  ...
  <div class="tbl-header2">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <tr><th style=" font-size:15px;font-family: 'Lato', sans-serif;">Employee Name:&nbsp;&nbsp; &nbsp;&nbsp;<span style="color:blue;font-family:Gill Sans MT;"><?php  echo $FIRST." ".$LAST  ?></span></th>
          <th style=" font-size:15px;font-family: 'Lato', sans-serif;">Employee Post:&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue;font-family:Gill Sans MT"><?php  echo $POSITION ?></span></th></tr>
          <tr><th style=" font-size:15px;font-family: 'Lato', sans-serif;">Employee Department:&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue;font-family:Gill Sans MT"><?php  echo $DEPARTMENT ?></span></th>
          <th style=" font-size:15px;font-family: 'Lato', sans-serif;">Employee Supervisor:&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:blue;font-family:Gill Sans MT">Liliane Uwimana</span></th></tr>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $result = mysqli_query($conn,"SELECT * FROM `roll_call_attendance` WHERE USER_ID = $ID LIMIT $offset, $total_records_per_page");
