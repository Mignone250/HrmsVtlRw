        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-list"></i>Students&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;E_learning students</li>
...
$email = mysqli_real_escape_string($conn, $_REQUEST['email']);
	...
	$sql_t = "SELECT * FROM  e_learning_students_registration WHERE sid='$sid'";
...
$sql = "INSERT INTO e_learning_students_registration (fname,lname,dob,gdates,sid,companyrecommended,employmentstatus,comments,email)
...
<div class="col-sm-12">
		<form action="" method="post" enctype="multipart/form-data">
		  ...
		  <?php 
$sql ="SELECT * FROM  e_learning_students_registration"; 
